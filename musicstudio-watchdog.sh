#!/bin/bash
#
# Music Studio KH — health watchdog for the always-on server.
#
...
#
PORT=47869
LABEL="com.kh.musicstudio.server"
ROOT="$(cd "$(dirname "$0")" && pwd)"
FAILURE_FILE="${MUSICSTUDIO_WATCHDOG_STATE_FILE:-$ROOT/service/.watchdog-failures}"
FAILURES_REQUIRED="${MUSICSTUDIO_WATCHDOG_FAILURES_REQUIRED:-3}"
CURL_BIN="${MUSICSTUDIO_WATCHDOG_CURL_BIN:-curl}"
LAUNCHCTL_BIN="${MUSICSTUDIO_WATCHDOG_LAUNCHCTL_BIN:-launchctl}"

...
# across temp files and a large repo can loop without ever completing -- this
# has already hit Chat Studio, Voice Studio, and Image Studio.  With the
# classic HTTP transport the same repos completed in one pass.
#
# This must run before huggingface_hub is imported, because its constants
# module reads the flag at import time.  Set MUSICSTUDIO_ENABLE_XET=1 to opt
# back in.
if os.environ.get("MUSICSTUDIO_ENABLE_XET") != "1":

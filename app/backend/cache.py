    ...
    try:
        for snap in snaps.iterdir():
            ...
            for path in snap.rglob("*"):
                # rglob follows the symlinks HF creates from snapshots into
                # blobs, so checking the symlink name is sufficient. Skip
                # incomplete partial files — they don't count.
                name = path.name
